...
public final class BigFraction extends Number implements Comparable<BigFraction>, NativeOperators<BigFraction>, Serializable {
     ...
     */
    private static BigFraction from(final double value, final double epsilon, final int maxDenominator, final int maxIterations) {
     ...
     * @return a new instance.
     */
    public static BigFraction from(final double value, final double epsilon, final int maxIterations) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
    ...
    private long toFloatingPointBits(int exponentLength, int significandLength) {
        ...
        long significand = roundAndRightShift(quotient, quotRightShift, !divisor.equals(BigInteger.ONE)).longValue();
        /*
        ...
        //special exponent for infinities and NaN
        final long maxExponent = (1L << exponentLength) - 1L;
        if (exponent >= maxExponent) {
            ...
            //smaller than the smallest normalized number
            /*
             ...
             */
            significand = roundAndRightShift(quotient, (1 - exponentBias - significandLength) - (numRightShift - denRightShift), !divisor.equals(BigInteger.ONE)).longValue();
            exponent = 0L;
            /*

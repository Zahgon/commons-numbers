...
public class SumPerformance {
     ...
     */
    private static void runSingle(final ArrayInput input, final Blackhole bh, final ToDoubleFunction<double[]> fn) {
     ...
     * @param fn function to benchmark
     */
    private static void runDouble(final ArrayInput input, final Blackhole bh, final ToDoubleBiFunction<double[], double[]> fn) {
        final double[][] a = input.getA();

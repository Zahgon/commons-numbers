...
public class NormPerformance {
     ...
     * @param bh blackhole
     */
    private static void eval(final ToDoubleFunction<double[]> fn, final VectorArrayInput input, final Blackhole bh) {
     ...
     * @param bh blackhole
     */
    private static void eval(final Norm fn, final VectorArrayInput input, final Blackhole bh) {
        final double[][] vectors = input.getVectors();
        for (int i = 0; i < vectors.length; ++i) {
